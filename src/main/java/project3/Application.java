...
public class Application {
    ...
    private static Dataset<Row> buildDurhamParksDataFrame(SparkSession spark) {
        ...
        Dataset<Row> df = spark.read().format("json")
                ...
                .load("/Users/akira/sparkwithjava/project3/src/main/resources/durham-parks.json");

        df = df.withColumn("park_id", concat(df.col("datasetid"), lit("_"),
                df.col("fields.objectid"), lit("_DFurham")))
    ...
    private static Dataset<Row> buildPhilParksDataFrame(SparkSession spark) {
        ...
        Dataset<Row> df = spark.read().format("csv")
                .option("multiline", true)
                .option("header", true)
                .load("/Users/akira/sparkwithjava/project3/src/main/resources/philadelphia_recreations.csv");
    ...
    private static void combineDataframes(Dataset<Row> df1, Dataset<Row> df2) {
        ...
        // if we just use the union() method, it matches the columns based on order.
